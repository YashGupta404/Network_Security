...
dagshub.init(repo_owner='yashgupta.work.2005', repo_name='Network_Security', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classification_metric, run_name="model-run"):
        mlflow.set_tracking_uri("https://dagshub.com/yashgupta.work.2005/NetworkSecurityML.mlflow")
    ...
    def train_model(self, X_train, y_train, x_test, y_test):
        ...
        # Save final model with preprocessing
